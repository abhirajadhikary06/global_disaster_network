...
# Load the dataset
data = pd.read_csv("/Users/anikchand/Documents/Floodless/floodless/prediction/templates/cleaned_datasets/earthquake_cleaned.csv")
...
num_samples = 25  # Number of unique combinations to sample (25 * 8 years = 200 rows)
...
future_df.to_csv("earthquake_predicted.csv", index=False)

print("Future predictions saved to 'earthquake_predicted.csv'")