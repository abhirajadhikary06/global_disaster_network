...
# Load the dataset
dataset_path = "/Users/anikchand/Documents/Floodless/floodless/prediction/templates/cleaned_datasets/wildfire_cleaned.csv"
...
num_samples = 11  # Number of unique combinations to sample (11 * 8 years ≈ 90 rows)
...
output_file = "wildfire_predicted.csv"  # Update this file name as needed
