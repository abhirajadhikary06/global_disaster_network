...
# Load the dataset
data = pd.read_csv("/Users/anikchand/Documents/Floodless/floodless/prediction/templates/cleaned_datasets/storm_cleaned.csv")
...
num_samples = 94  # Number of unique combinations to sample (94 * 8 years ≈ 749 rows)
...
future_df.to_csv("storm_predicted.csv", index=False)

print("Future predictions saved to 'storm_predicted.csv'")