...
# Load the dataset (replace 'dataset_path' with the actual file path)
dataset_path = "/Users/anikchand/Documents/Floodless/floodless/prediction/templates/cleaned_datasets/volcano_cleaned.csv"  # Update this path
...
num_samples = 5  # Number of unique combinations to sample (5 * 8 years ≈ 40 rows)
...
# Truncate the dataset to exactly 36 rows
future_df = future_df.iloc[:36]

# Save the future dataset
output_file = "volcano_predicted.csv"  # Update this file name as needed
